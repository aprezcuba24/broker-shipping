 ...
 */
export const forgotPasswordUsersForgotPasswordPost = (
...
export const getForgotPasswordUsersForgotPasswordPostMutationOptions = <TError = HTTPValidationError,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof forgotPasswordUsersForgotPasswordPost>>, TError,{data: ForgotPasswordRequest}, TContext>, request?: SecondParameter<typeof brokerFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof forgotPasswordUsersForgotPasswordPost>>, TError,{data: ForgotPasswordRequest}, TContext> => {

const mutationKey = ['forgotPasswordUsersForgotPasswordPost'];
const {mutation: mutationOptions, request: requestOptions} = options ?
      options.mutation && 'mutationKey' in options.mutation && options.mutation.mutationKey ?
      options
      : {...options, mutation: {...options.mutation, mutationKey}}
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof forgotPasswordUsersForgotPasswordPost>>, {data: ForgotPasswordRequest}> = (props) => {
          const {data} = props ?? {};

          return  forgotPasswordUsersForgotPasswordPost(data,requestOptions)
        }
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type ForgotPasswordUsersForgotPasswordPostMutationResult = NonNullable<Awaited<ReturnType<typeof forgotPasswordUsersForgotPasswordPost>>>
    export type ForgotPasswordUsersForgotPasswordPostMutationBody = ForgotPasswordRequest
    export type ForgotPasswordUsersForgotPasswordPostMutationError = HTTPValidationError

    /**
 * @summary Forgot Password
 */
export const useForgotPasswordUsersForgotPasswordPost = <TError = HTTPValidationError,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof forgotPasswordUsersForgotPasswordPost>>, TError,{data: ForgotPasswordRequest}, TContext>, request?: SecondParameter<typeof brokerFetch>}
 , queryClient?: QueryClient): UseMutationResult<
        Awaited<ReturnType<typeof forgotPasswordUsersForgotPasswordPost>>,
        TError,
        {data: ForgotPasswordRequest},
        TContext
      > => {

      const mutationOptions = getForgotPasswordUsersForgotPasswordPostMutationOptions(options);
 ...
 */
export const resetPasswordEndpointUsersResetPasswordPost = (
...
export const getResetPasswordEndpointUsersResetPasswordPostMutationOptions = <TError = HTTPValidationError,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof resetPasswordEndpointUsersResetPasswordPost>>, TError,{data: ResetPasswordRequest}, TContext>, request?: SecondParameter<typeof brokerFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof resetPasswordEndpointUsersResetPasswordPost>>, TError,{data: ResetPasswordRequest}, TContext> => {

const mutationKey = ['resetPasswordEndpointUsersResetPasswordPost'];
const {mutation: mutationOptions, request: requestOptions} = options ?
      options.mutation && 'mutationKey' in options.mutation && options.mutation.mutationKey ?
      options
      : {...options, mutation: {...options.mutation, mutationKey}}
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof resetPasswordEndpointUsersResetPasswordPost>>, {data: ResetPasswordRequest}> = (props) => {
          const {data} = props ?? {};

          return  resetPasswordEndpointUsersResetPasswordPost(data,requestOptions)
        }
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type ResetPasswordEndpointUsersResetPasswordPostMutationResult = NonNullable<Awaited<ReturnType<typeof resetPasswordEndpointUsersResetPasswordPost>>>
    export type ResetPasswordEndpointUsersResetPasswordPostMutationBody = ResetPasswordRequest
    export type ResetPasswordEndpointUsersResetPasswordPostMutationError = HTTPValidationError

    /**
 * @summary Reset Password Endpoint
 */
export const useResetPasswordEndpointUsersResetPasswordPost = <TError = HTTPValidationError,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof resetPasswordEndpointUsersResetPasswordPost>>, TError,{data: ResetPasswordRequest}, TContext>, request?: SecondParameter<typeof brokerFetch>}
 , queryClient?: QueryClient): UseMutationResult<
        Awaited<ReturnType<typeof resetPasswordEndpointUsersResetPasswordPost>>,
        TError,
        {data: ResetPasswordRequest},
        TContext
      > => {

      const mutationOptions = getResetPasswordEndpointUsersResetPasswordPostMutationOptions(options);
