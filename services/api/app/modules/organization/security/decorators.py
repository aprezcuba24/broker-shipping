...
def require_org_provider(func: F) -> F:
    """Require an active provider membership for ``organization_id`` (use below ``@require_user``)."""
    ...
    async def wrapper(*args: Any, **kwargs: Any) -> Any:
        ...
        await membership.require_provider(principal.user_id, organization_id)
